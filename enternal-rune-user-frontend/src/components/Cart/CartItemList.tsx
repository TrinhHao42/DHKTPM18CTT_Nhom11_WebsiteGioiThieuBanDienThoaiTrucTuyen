...
const CartItemList = React.memo(({ item, isSelected, onToggle }: CartItemListProps) => {
    ...
    return (
        <div
            className={`relative flex items-start gap-4 p-4 border-b last:border-b-0 transition-all duration-150 ${isSelected ? 'bg-blue-50' : 'hover:bg-gray-50'
                ...
                item.productVariantResponse && (
                    <>
                        ...
                        <div className="flex-1 items-start mb-3">
                            ...
                            <p className="text-[10px] sm:text-xs text-gray-800 mb-2">
                                Phiên bản: {item.productVariantResponse.storage || 'N/A'}, Màu: {item.productVariantResponse.color || 'N/A'}
                            </p>
                        ...
                        <div className="flex flex-col items-end gap-3 mt-2">
                            ...
                            <div className="flex items-center gap-3 self-end">
                                <p className="text-base sm:text-lg font-bold text-gray-900">
                                    {item.productVariantResponse.price.toLocaleString("vi-VN", {
                                        style: "currency",
                                        currency: "VND",
                                    })}
                                </p>
