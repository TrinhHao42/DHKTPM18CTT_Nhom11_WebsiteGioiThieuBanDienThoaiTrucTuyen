    ...
    <Modal isOpen={isOpen} onClose={onClose} className="max-w-4xl" showCloseButton={false}>
      <div className="flex h-[80vh] flex-col overflow-hidden relative">
        ...
        <div 
          ...
          className="relative flex-1 overflow-y-auto overflow-x-hidden bg-gray-50 p-6 dark:bg-gray-900/50"
        >
        ...
        {showScrollButton && (
          <button
            ...
            className="absolute bottom-28 left-1/2 -translate-x-1/2 w-12 h-12 bg-brand-500 hover:bg-brand-600 text-white rounded-full shadow-lg flex items-center justify-center transition-all active:scale-95 animate-fadeInUp z-10"
            title="Xuống cuối"
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3">
                ...
                <textarea
                  ...
                  rows={1}
                  className="min-h-[48px] max-h-[200px] flex-1 resize-none overflow-y-auto rounded-full border border-gray-200 bg-white px-4 py-3 text-sm text-gray-900 placeholder:text-gray-400 focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-500/20 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-500"
                  disabled={isUploading}
                />
